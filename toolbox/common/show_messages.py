...
if __name__ == '__main__':
    ...
    test_messages = [
        ...
        { 'item': 'this item has a long message',
          'message': 'This message is very long and should be properly wrapped so that we can see '
                     'it correctly in the terminal without the need for constantly resizing the'
                     'terminal'},
    ]
    show_messages(test_messages)
