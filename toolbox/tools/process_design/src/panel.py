"""
Panel with controls for process design tool
"""
...
class Panel(wx.Panel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        sizer.Add(self._create_controls(), 0, wx.EXPAND | wx.ALL, GuiSizes.BOX_SPACING)
    ...
    def _create_controls(self):
        ...
        btn_process = wx.Button(self, self.ID_BTN_PROCESS, "Process design")
